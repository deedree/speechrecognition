...
export class DialogServiceAdapter extends ServiceRecognizerBase {
    ...
    sendWaveHeader(connection) {
        return connection.send(new SpeechConnectionMessage(MessageType.Binary, "audio", this.privDialogRequestSession.requestId, null, this.audioSource.format.header));
    }
